...
<!-- ![version badge](https://img.shields.io/docker/v/moert09/protonmail-bridge)
![image size badge](https://img.shields.io/docker/image-size/moert09/protonmail-bridge/build)
![docker pulls badge](https://img.shields.io/docker/pulls/moert09/protonmail-bridge) -->
<!-- ![deb badge](https://github.com/moert09/protonmail-bridge-docker/workflows/pack%20from%20deb/badge.svg) -->
![build badge](https://github.com/moert09/protonmail-bridge-docker/workflows/build%20from%20source/badge.svg)
...
This is a fork from <https://github.com/shenxn/protonmail-bridge-docker> with GitHub actions fixed (amd64 only for now).

GitHub: [https://github.com/moert09/protonmail-bridge-docker](https://github.com/moert09/protonmail-bridge-docker)
...
```
docker run --rm -it -v protonmail:/root ghcr.io/moert09/protonmail-bridge-docker:build init
```
...
```
docker run -d --name=protonmail-bridge -v protonmail:/root -p 1025:25/tcp -p 1143:143/tcp --restart=unless-stopped ghcr.io/moert09/protonmail-bridge-docker:build
```
...
```
docker run -d --name=protonmail-bridge -v protonmail:/root -p 127.0.0.1:1025:25/tcp -p 127.0.0.1:1143:143/tcp --restart=unless-stopped ghcr.io/moert09/protonmail-bridge-docker:build
```
